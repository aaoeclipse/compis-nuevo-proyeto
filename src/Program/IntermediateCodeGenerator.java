...
public class IntermediateCodeGenerator<T> extends DECAF2BaseVisitor<Object> {
    ...
    public Object visitAssign(DECAF2Parser.AssignContext ctx) {
        ...
        if (isSimpleLocation) {
            ...
            Symbol symbol = tablaCodigo.findSymbolInGlobalScope(result, scopeActual);
    ...
    /**
     * Agrega la cantidad extra para el length
     */
    ...
    /**
     *
     * @param ctx recieve un tree de while
     * @return
     */
    @Override
    ...
    public Object visitStructDeclaration(DECAF2Parser.StructDeclarationContext ctx) {
        ...
        code.setLabel(etiqueta+":");
        System.out.println(ctx);
        for (int i = 3; i < len-1; i++) {
            this.visit(ctx.getChild(i));
        }
//        code.setCode();
        tablaCodigo.addCodigo(code);
        scopeActual = nuevoScope;
