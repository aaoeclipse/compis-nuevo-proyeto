...
import DECAF2.TextLineNumber;
import DECAF2.TreeBuilder;
...
public class GUI extends JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new ImageIcon(getClass().getResource("/icons/addTab2.jpg"))); // NOI18N
        ...
        jButton2.setIcon(new ImageIcon(getClass().getResource("/icons/openFIleConverted.png"))); // NOI18N
        ...
        jButton3.setIcon(new ImageIcon(getClass().getResource("/icons/saveFileConverted.png"))); // NOI18N
        ...
        jMenuItem3.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Q, java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenuItem6.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_T, java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenuItem4.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenuItem2.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_I, java.awt.event.InputEvent.CTRL_MASK));
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(layout.createSequentialGroup()
                                                                .addComponent(jTabbedPane1, GroupLayout.DEFAULT_SIZE, 732, Short.MAX_VALUE)
                                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(jSeparator3, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE)))
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(jTabbedPane3, GroupLayout.PREFERRED_SIZE, 399, GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap())
        );
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(jTabbedPane1, GroupLayout.DEFAULT_SIZE, 387, Short.MAX_VALUE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jSeparator1, GroupLayout.PREFERRED_SIZE, 10, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTabbedPane2, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
                                .addContainerGap())
        );
    ...
    public JScrollPane initializeLogAndTreeTabs(String text, Color color) {
        ...
        log.setFont(new Font("Eras Medium ITC", 0, 15));
        log.setBorder(BorderFactory.createTitledBorder("Log - Compilador"));
        if (color != null) {
    ...
    public JComponent createTab() {
        ...
        textPane.setBorder(BorderFactory.createLineBorder(new Color(0, 0, 0)));
    ...
    private ParseTree generarArbol() {
        ...
        if (!DescriptiveErrorListener.errores.isEmpty()) {
            ...
            System.out.println(DescriptiveErrorListener.errores.toString());
            // Mostrar errores
    ...
    public void openFile() {
        ...
        try {
            JFileChooser file=new JFileChooser("/home/eclipse/Desktop/Pruebas2");
    ...
    private void imprimirMensajesLog() {
        ...
        JTextPane textPane = new JTextPane();
        textPane.setFont(new Font("Eras Medium ITC", 0, 15));
        textPane.setBorder(BorderFactory.createTitledBorder("Log - Compilador"));
